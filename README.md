...
- [**Haladó programozóknak (Developer Guide)**](https://github.com/davideak22/pertu-mi/blob/main/README.md#halado-programozoknak) — Ha ismeri a Git-et, a Node.js-t és a parancssor használatát.
- [**Kezdőknek és technikai tapasztalattal nem rendelkezőknek (Beginner Guide)**](https://github.com/davideak22/pertu-mi/blob/main/README.md#kezdoknek-es-technikai-tapasztalattal-nem-rendelkezoknek) — Részletes, lépésről lépésre követhető útmutató a szükséges szoftverek telepítésével és parancsok magyarázatával.
